...
# preprocessing
basedirs = [
    'samples/trees_sf/20211128_ULNanoV9_ak8_qcd_2018/bdt', # sample dedicated for training
]
flist_train = [
    ('qcd', 'qcd_bdt_train.root'),
]
flist_pred = [
    # 'mc/ggH-cc_tree.root',
    'mc/qcd-mg_tree.root',
...
basesel = f'passHTTrig & fj_{x}_pt>200 & fj_{x}_sdmass>50 & fj_{x}_sdmass<200 & passmetfilters & (fj_{x}_nbhadrons>=2 | fj_{x}_nchadrons>=2)'
